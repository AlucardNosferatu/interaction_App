...
void Ads1298Decoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Ads1298Decoder *_t = static_cast<Ads1298Decoder *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (Ads1298Decoder::*_t)(int , double * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Ads1298Decoder::hasNewDataPacket)) {
                *result = 0;
            }
        }
        {
            typedef void (Ads1298Decoder::*_t)(char );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Ads1298Decoder::hasNewCmdReply)) {
                *result = 1;
            }
        }
        {
            typedef void (Ads1298Decoder::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Ads1298Decoder::hasNewWifiConnection)) {
                *result = 2;
            }
        }
    }
...
const QMetaObject Ads1298Decoder::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Ads1298Decoder.data,
      qt_meta_data_Ads1298Decoder,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Ads1298Decoder::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Ads1298Decoder.stringdata0))
        return static_cast<void*>(const_cast< Ads1298Decoder*>(this));
