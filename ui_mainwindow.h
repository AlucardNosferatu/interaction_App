...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gestureText->setGeometry(QRect(1190, 520, 341, 131));
        QFont font;
        ...
        groupBox->setGeometry(QRect(1340, 660, 191, 80));
